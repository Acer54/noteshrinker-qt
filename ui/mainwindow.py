...
class Ui_MainWindow_noteshrinker_qt(object):
    def setupUi(self, MainWindow_noteshrinker_qt):
        ...
        MainWindow_noteshrinker_qt.resize(1237, 910)
        ...
        self.tW_workbench = Workbench_Tablewidget(self.widget)
        ...
        self.gB_preview = QtGui.QGroupBox(self.widget)
        ...
        self.gB_settings = QtGui.QGroupBox(self.widget)
